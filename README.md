...
Je conçois et livre des applications web de bout en bout : front, back, mise en production (PaaS managé, VPS self-hosted) avec CI/CD. Architectures monorepo, typage partagé client/serveur, multi-bases et flux sécurisés. Tests unitaires, d'intégration et E2E selon les priorités. Expérience en automatisation de process à l'échelle d'un groupe multi-sociétés et en environnement réglementé (médico-social, ISO 27001).
