...
Je livre des applications web de bout en bout : conception, front, back, mise en production (PaaS managé, VPS self-hosted), CI/CD. Architectures monorepo, typage partagé client/serveur, multi-base et flux sécurisés (CA interne). Tests unitaires, d'intégration et E2E selon les priorités. Expérience en automatisation de process à l'échelle d'un groupe multi société et en environnement réglementé (médico-social, ISO 27001).
